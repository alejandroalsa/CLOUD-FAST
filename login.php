    ...
    <?php endif ?>
      <form  method="POST" action="login.php">
        ...
        <div class="form-floating mt-2">
          <input type="text" class="form-control" id="user" name="user" placeholder="cloudfast">
        ...
        <div class="checkbox mb-3 mt-3">
          ...
          <p class="mt-3">¿No tienes cueta? <a href="register.php">Registrate</a></p>
        </div>
