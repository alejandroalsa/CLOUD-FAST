<?php
  ...
  ini_set('display_errors', 1);
    ...
    $all_user_records = array_merge($user_files);
...
<html lang="es">
  ...
  <body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
      <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="index.php">CLOUD~FAST | ARCHIVOS</a>
        ...
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            <div class="position-sticky pt-3 sidebar-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="archive.php" style="font-size: 16px;">
                  ...
                  <div class="dropzone">Arrastra y suelta el archivo aquí</div>
                    <div id="filePreview"></div>
                      <label class="btn btn-primary mt-3">
                        ...
                        <input type="file" id="fileInput" name="archivo" style="display: none;" accept=".txt, .zip, .rar, .html, .css, .js, .php, .py, .c, .cpp, .java, .rb, .pl, .go, .d, .xml, .yml, .json, .md">
                      </label>
                      <script>
