<?php
  ...
  ini_set('display_errors', 1);
    ...
    $all_user_records = array_merge($user_documents);
?>
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">CLOUD~FAST | DOCUMENTOS</a>
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="documents.php" style="font-size: 16px;">
                  ...
                  <div class="dropzoneDocument">Arrastra y suelta un documento aquí</div>
                    <div id="filePreviewDocument"></div>
                      <label class="btn btn-danger mt-3">
                        ...
                        <input type="file" id="fileInputDocument" name="documento" style="display: none;" accept=".doc, .docx, .xls, .xlsx, .ppt, .pptx, .pdf, .odt, .ods, .odp, .rtf, .txt, .md">
                      </label>
                      <script>
